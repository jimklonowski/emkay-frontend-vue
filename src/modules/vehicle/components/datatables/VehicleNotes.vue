            ...
            <v-list-item link>
              <v-list-item-icon>
                ...
                <v-list-item-content>
                  ...
                  <v-list-item-title>
                    <json-excel v-t="'common.export_to_excel'" :fields="getHeaders" :data="vehicle_notes" :name="getName" />
                  </v-list-item-title>
                </v-list-item-content>
            </v-list-item>
          </template>
...
export default {
  ...
  created() {
    let url = `/vehicle/notes/${this.vehicle}`
