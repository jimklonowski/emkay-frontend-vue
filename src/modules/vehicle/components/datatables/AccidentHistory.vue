            ...
            <v-list-item link>
              <v-list-item-icon>
                ...
                <v-list-item-content>
                  ...
                  <v-list-item-title>
                    <json-excel v-t="'common.export_to_excel'" :fields="getHeaders" :data="accident_history" :name="getName" />
                  </v-list-item-title>
                </v-list-item-content>
            </v-list-item>
          </template>
...
export default {
  ...
  data: self => ({
    ...
    search: '',
    title: {
      key1: 'vehicle_dashboard.accident',
  ...
  created() {
    let url = `/vehicle/accidents/${this.vehicle}`
